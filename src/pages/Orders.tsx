          ...
          <div className="order mb-[120px]">
            <header className="flex justify-between mb-[44px]">
              <div className="flex items-center gap-[24px]">
                ...
                <Button textColor="#414141" bgColor="#F3F2F1">
                  В процессе
                </Button>
              </div>
              <div className="flex items-center gap-[24px]">
                ...
                >
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M2.5 6C2.5 4.61929 3.61929 3.5 5 3.5H19C20.3807 3.5 21.5 4.61929 21.5 6V20C21.5 21.3807 20.3807 22.5 19 22.5H5C3.61929 22.5 2.5 21.3807 2.5 20V6ZM5 4.5C4.17157 4.5 3.5 5.17157 3.5 6V20C3.5 20.8284 4.17157 21.5 5 21.5H19C19.8284 21.5 20.5 20.8284 20.5 20V6C20.5 5.17157 19.8284 4.5 19 4.5H5Z"
                      fill="#414141"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M16 1.5C16.2761 1.5 16.5 1.72386 16.5 2V6C16.5 6.27614 16.2761 6.5 16 6.5C15.7239 6.5 15.5 6.27614 15.5 6V2C15.5 1.72386 15.7239 1.5 16 1.5Z"
                      fill="#414141"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M8 1.5C8.27614 1.5 8.5 1.72386 8.5 2V6C8.5 6.27614 8.27614 6.5 8 6.5C7.72386 6.5 7.5 6.27614 7.5 6V2C7.5 1.72386 7.72386 1.5 8 1.5Z"
                      fill="#414141"
                    />
                    <path
                      fill-rule="evenodd"
          ...
          <div className="order mb-[120px]">
            <header className="flex justify-between mb-[44px]">
              <div className="flex items-center gap-[24px]">
                ...
                <Button className="bg-[#D80000]" textColor="#fff">
                  Не доставили
                </Button>
              </div>
              <div className="flex items-center gap-[24px]">
          ...
          <div className="order">
            <header className="flex justify-between mb-[44px]">
              <div className="flex items-center gap-[24px]">
                ...
                <Button textColor="#fff" bgColor="#70C05B">
                  Получен
                </Button>
              </div>
              <div className="flex items-center gap-[24px]">
